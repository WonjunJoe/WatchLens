...
export function LandingPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[var(--bg)] text-[var(--text-primary)] overflow-x-hidden" style={{ wordBreak: "keep-all" }}>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-16 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="pt-24 lg:pt-0">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-snug tracking-tight mb-6 animate-fadeInUp stagger-1 text-[var(--text-primary)]">
                나의 디지털 습관을<br />
                데이터로 마주하다
              </h1>
              <p className="text-base md:text-lg text-[var(--text-secondary)] leading-relaxed max-w-[50ch] mb-10 animate-fadeInUp stagger-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fadeInUp stagger-3">
                <Link
                  to="/upload"
                  className="group bg-[var(--accent)] hover:opacity-90 text-white font-medium px-7 py-3.5 rounded-full text-base flex items-center justify-center gap-3 active:scale-[0.98] hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]"
                  style={{ transition: "all 0.5s cubic-bezier(0.16, 1, 0.3, 1)" }}
                >
                  무료로 분석 시작하기
                ...
                <div className="card p-5 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)]">
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    <div className="bg-[var(--bg)] rounded-xl p-3 border border-[var(--border)]">
                      ...
                      <div className="text-xl font-bold text-[var(--text-primary)]">2,847</div>
                      <div className="text-[11px] text-[var(--green)] mt-1">+12.3%</div>
                    </div>
                    <div className="bg-[var(--bg)] rounded-xl p-3 border border-[var(--border)]">
                      <div className="text-[11px] text-[var(--text-tertiary)] mb-1">시청 시간</div>
                      <div className="text-xl font-bold text-[var(--text-primary)]">186h</div>
                      <div className="text-[11px] text-[var(--amber)] mt-1">일 1.2h</div>
                    </div>
                    <div className="bg-[var(--bg)] rounded-xl p-3 border border-[var(--border)]">
                      <div className="text-[11px] text-[var(--text-tertiary)] mb-1">Shorts 비율</div>
                      <div className="text-xl font-bold text-[var(--text-primary)]">34%</div>
      ...
      <section id="features" className="relative z-10 py-20 md:py-28 lg:py-36 bg-[var(--surface)] border-t border-[var(--border)]">
        <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div data-reveal className="md:col-span-4 card p-6">
              <div className="w-10 h-10 rounded-2xl bg-[var(--accent-light)] flex items-center justify-center mb-5">
                <BarChart3 size={20}className="text-[var(--accent)]" />
              </div>
              <h3 className="text-lg font-bold mb-2 leading-snug">시청 패턴 분석</h3>
              <p className="text-[var(--text-secondary)] text-[15px] leading-relaxed max-w-[50ch]">
            ...
            <div data-reveal className="md:col-span-2 card p-6">
              <div className="w-10 h-10 rounded-2xl bg-[var(--green-light)] flex items-center justify-center mb-5">
                <Clock size={20}className="text-[var(--green)]" />
              </div>
              <h3 className="text-lg font-bold mb-2 leading-snug">시청 시간 추적</h3>
            ...
            <div data-reveal className="md:col-span-2 card p-6">
              <div className="w-10 h-10 rounded-2xl bg-[var(--amber-light)] flex items-center justify-center mb-5">
                <TrendingUp size={20}className="text-[var(--amber)]" />
              </div>
              <h3 className="text-lg font-bold mb-2 leading-snug">도파민 지수</h3>
              <p className="text-[var(--text-secondary)] text-[15px] leading-relaxed">
            ...
            <div data-reveal className="md:col-span-4 card p-6">
              <div className="w-10 h-10 rounded-2xl bg-[var(--rose-light)] flex items-center justify-center mb-5">
                <MessageCircle size={20}className="text-[var(--rose)]" />
              </div>
              <h3 className="text-lg font-bold mb-2 leading-snug">Instagram DM 분석</h3>
              <p className="text-[var(--text-secondary)] text-[15px] leading-relaxed max-w-[50ch]">
            ...
            {/* Card 5 (col-span-3) */}
            <div data-reveal className="md:col-span-3 card p-6">
              <div className="w-10 h-10 rounded-2xl bg-cyan-50 flex items-center justify-center mb-5">
                <Users size={20}className="text-cyan-500" />
              </div>
              <h3 className="text-lg font-bold mb-2 leading-snug">채널 · 계정 랭킹</h3>
              <p className="text-[var(--text-secondary)] text-[15px] leading-relaxed">
            ...
            <div data-reveal className="md:col-span-3 card p-6">
              ...
              <h3 className="text-lg font-bold mb-2 leading-snug">검색 키워드 분석</h3>
              <p className="text-[var(--text-secondary)] text-[15px] leading-relaxed">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="relative z-10 py-20 md:py-28 lg:py-36 border-t border-[var(--border)]">
        <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="text-center mb-16" data-reveal>
            <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] uppercase tracking-[0.15em] font-medium bg-[var(--accent-light)] text-[var(--accent)] mb-4">
              사용법
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6" data-reveal>
            {[
              ...
              <div key={item.step} className="text-center md:text-left">
                <div className="text-4xl font-bold text-[var(--accent)] opacity-15 mb-4">{item.step}</div>
      ...
      {/* CTA Section */}
      <section className="relative z-10 py-20 md:py-28 lg:py-36 bg-[var(--surface)] border-t border-[var(--border)]">
        <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="card px-8 py-12 md:py-20 text-center relative overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)]" data-reveal>
            ...
            <div className="relative z-10">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-snug tracking-tight mb-4">
                지금 바로 시작해보세요
              </h2>
              <p className="text-[var(--text-secondary)] text-lg leading-relaxed max-w-[45ch] mx-auto mb-10">
                당신의 데이터는 서버에 저장되지 않습니다.
                업로드하고, 분석하고, 나만의 인사이트를 발견하세요.
              </p>
              <Link
                to="/upload"
                className="group inline-flex items-center gap-3 bg-[var(--accent)] hover:opacity-90 text-white font-medium px-7 py-3.5 rounded-full text-base active:scale-[0.98] hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]"
                style={{ transition: "all 0.5s cubic-bezier(0.16, 1, 0.3, 1)" }}
              >
                분석 시작하기
                <span className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center group-hover:translate-x-1" style={{ transition: "all 0.5s cubic-bezier(0.16, 1, 0.3, 1)" }}>
