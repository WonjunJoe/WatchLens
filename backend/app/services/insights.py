...
def generate_insights(
    ...
    if hourly:
        ...
        insights.append({
            "icon": "⏰",
            "text": f"가장 많이 시청한 시간대는 {peak['hour']}시 ({peak['count']}건)입니다.",
        })
